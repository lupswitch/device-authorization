...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE) {
			$this->load->model('device_authorization');
			$this->ion_auth->set_hook('pre_login', 'verify_device_authorization', $this->device_authorization, $this->device_authorization->verify_device($this->input->post('identity')), $this->input->post('identity'));
